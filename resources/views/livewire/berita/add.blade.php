<div class="container mx-auto py-8">
    ...
    @endif
    <form wire:submit.prevent="addBerita" enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <textarea id="isi" name="isi" wire:model="isi" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" placeholder="Enter the isi" rows="4" required></textarea>
        </div>
        <div class="mb-4">
            <label for="link" class="block text-gray-700 font-bold mb-2">Link Berita</label>
            <textarea id="link" name="link" wire:model="link" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" placeholder="Enter the link" rows="4" required></textarea>
        </div>
        <div class="mb-4">
            <label for="image" class="block text-gray-700 font-bold mb-2">Image URL</label>
            <input type="file" id="image" name="image" wire:model="image" class="w-full border-gray-300 rounded-md px-3 py">
        </div>
