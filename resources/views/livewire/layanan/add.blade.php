<div class="container mx-auto py-8">
    <h1 class="text-xl font-bold mb-4 text-center">Request Layanan atau Fasilitas</h1>
    @if ($errors->any())
    ...
    <form enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
        <div class="mb-4">
            ...
            <select id="layanan" name="layanan" wire:model="layanan" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" required>
                <option value="" hidden>Pilih Layanan atau Fasilitas</option>
        ...
        <div class="mb-4">
            ...
            <textarea id="keterangan" name="keterangan" wire:model="keterangan" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" placeholder="Masukan Alasan Request Layanan atau Fasilitas" rows="4" required></textarea>
        </div>
