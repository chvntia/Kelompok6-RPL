<div class="container mx-auto py-8">
    ...
    <form enctype="multipart/form-data" class="max-w-md mx-auto bg-white p-6 rounded-md shadow-md">
        <div class="mb-4">
            ...
            <input type="text" id="kegiatan" name="kegiatan" wire:model="kegiatan" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" placeholder="Enter the title" required>
        </div>
        <div class="mb-4">
        ...
        <div class="mb-4">
            <label for="images" class="block text-gray-700 font-bold mb-2">Image URL</label>
            <input type="file" id="images" name="images" wire:model="images" class="w-full border-gray-300 rounded-md px-3 py-2 focus:outline-none focus:border-blue-400" multiple placeholder="Insert the image">
        </div>
